...
const Benefits = () => {
  return (
    <section
      className="w-[95%] mx-auto my-25 rounded-4xl relative overflow-hidden py-12 px-3 text-white shadow-2xl shadow-black/30"
      style={{
    ...
    >
      <div className="text-center lg:pt-12 ">
        ...
        <p className="lg:w-[60%] lg:mx-auto text-3xl px-2 w-full lg:text-5xl font-bold my-2 tracking-tightest">
