...
import stepTwo from "@/assets/stepTwo.webp";
import { motion } from "motion/react";

const StepTwo = () => {
  const text = "Let AI Analyze & Optimize";
  ...
  return (
    ...
    >
      {letters.map((letter, index) => (
        ...
        <p className="text-[hsl(168,100%,98%)]/50 font-medium sm:w-[95%] lg:w-[80%] sm:text-sm">
          Our powerful AI algorithms analyze your data in real-time, identifying
          trends, opportunities, and areas for improvement. It then optimizes
          your marketing campaigns based on these insights.
        </p>
      </div>
    </section>
  );
